...
@property (nonatomic, readwrite) CGFloat selectionIndicatorWidth UI_APPEARANCE_SELECTOR;
@property (nonatomic, readwrite) UIImage *selectionIndicatorImage UI_APPEARANCE_SELECTOR;
